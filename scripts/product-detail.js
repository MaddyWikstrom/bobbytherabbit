...
renderProduct() {
    ...
    // Inject HTML (this creates #main-image + .thumbnail-grid)
    productGrid.innerHTML = `
        ...
        <!-- rest of your HTML here... keep unchanged for product info -->
    `;

    // Safely check and delay filtering
    if (
        ...
        setTimeout(() => {
            try {
                if (typeof this.filterImagesByColor ==
